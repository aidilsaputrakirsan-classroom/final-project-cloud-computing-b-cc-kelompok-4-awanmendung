...
<head>
    ...
    <title>Kontak - resepin.id</title>
    <meta name="description" content="Halaman kontak resepin.id untuk mengirim pesan, saran, dan masukan.">
    ...
    <style>
        ...
        /* Hero/banner umum (kalau mau dipakai di page lain) */
        .slider_bg_1 {
        ...
        /* ===== Banner khusus halaman kontak (breadcam_bg_5) ===== */
        .breadcam_bg_5 {
...
<body>
    ...
    <!-- bradcam_area / banner kontak -->
<div class="slider_area breadcam_bg_5">
