...
<body>
    ...
    <section class="popular-recipes section_padding">
  <div class="container">
    <div class="section-header text-center mb-5">
      <h2 class="section-title">Resep Populer</h2>
      <p class="section-subtitle">Pilihan paling disukai pengunjung</p>
    </div>
    ...
    <div class="row g-4">
      ...
      <div class="col-sm-6 col-md-4 col-lg-3">
        <article class="recipe-card">
          <div class="recipe-thumb">
            <img src="img/recipes/recipe-1.jpg" alt="Nasi Goreng Spesial" class="img-fluid">
            <span class="badge popular-badge">Popular</span>
          </div>
          <div class="recipe-body">
            <h3 class="recipe-title"><a href="/recipes/1">Nasi Goreng Spesial</a></h3>
            <p class="recipe-meta">
              <span class="me-2"><i class="ti-time"></i> 25 m</span>
              <span class="me-2"><i class="ti-user"></i> 2-3 porsi</span>
            </p>
            <div class="recipe-stats d-flex justify-content-between align-items-center">
              <div class="rating">
                <i class="fa fa-star"></i> <strong>4.8</strong> <small>(120)</small>
              </div>
              <div class="likes">
                <i class="fa fa-heart"></i> 340
              </div>
            </div>
          </div>
        </article>
      ...
      <!-- Duplicate card untuk resep lain -->
      <div class="col-sm-6 col-md-4 col-lg-3">
        <article class="recipe-card">
          <div class="recipe-thumb">
            <img src="img/recipes/recipe-2.jpg" alt="Pasta Creamy" class="img-fluid">
            <span class="badge popular-badge">Popular</span>
          </div>
          <div class="recipe-body">
            <h3 class="recipe-title"><a href="/recipes/2">Pasta Creamy Jamur</a></h3>
            <p class="recipe-meta">
              <span class="me-2"><i class="ti-time"></i> 30 m</span>
              <span class="me-2"><i class="ti-user"></i> 3-4 porsi</span>
            </p>
            <div class="recipe-stats d-flex justify-content-between align-items-center">
              <div class="rating">
                <i class="fa fa-star"></i> <strong>4.7</strong> <small>(98)</small>
              </div>
              <div class="likes">
