...
<body>
        ...
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <div class="login100-pic js-tilt" data-tilt>
                    <img src="<?php echo e(asset('images/buku.png')); ?>" alt="IMG">
                </div>

                
                <form class="login100-form validate-form" method="POST" action="<?php echo e(url('/login')); ?>">
                    <?php echo csrf_field(); ?>
    ...
    <?php if(session('register_prompt')): ?>
        <script>
...
<?php /**PATH C:\Users\USER\Documents\GitHub\final-project-cloud-computing-b-cc-kelompok-4-awanmendung\resources\views/login/index.blade.php ENDPATH**/ ?>